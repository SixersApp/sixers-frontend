...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,playerSeasonId,playerId,name,fullName,playerImage,role,countryName,countryImage,performanceId,runsScored,ballsFaced,fours,sixes,runsConceded,ballsBowled,wicketsTaken,catches,dismissals,caughtBehinds,widesBowled,byesBowled,runOuts,noBallsBowled,catchesDropped,insertedAt,homeTeamId,homeTeamName,homeTeamImage,awayTeamId,awayTeamName,awayTeamImage,fantasyPoints]);

@override
String toString() {
  return 'FantasyPlayer(playerSeasonId: $playerSeasonId, playerId: $playerId, name: $name, fullName: $fullName, playerImage: $playerImage, role: $role, countryName: $countryName, countryImage: $countryImage, performanceId: $performanceId, runsScored: $runsScored, ballsFaced: $ballsFaced, fours: $fours, sixes: $sixes, runsConceded: $runsConceded, ballsBowled: $ballsBowled, wicketsTaken: $wicketsTaken, catches: $catches, dismissals: $dismissals, caughtBehinds: $caughtBehinds, widesBowled: $widesBowled, byesBowled: $byesBowled, runOuts: $runOuts, noBallsBowled: $noBallsBowled, catchesDropped: $catchesDropped, insertedAt: $insertedAt, homeTeamId: $homeTeamId, homeTeamName: $homeTeamName, homeTeamImage: $homeTeamImage, awayTeamId: $awayTeamId, awayTeamName: $awayTeamName, awayTeamImage: $awayTeamImage, fantasyPoints: $fantasyPoints)';
}
...
@useResult
$Res call({
@JsonKey(name: "player_season_id", defaultValue: "") String playerSeasonId,@JsonKey(name: "player_id", defaultValue: "") String playerId,@JsonKey(name: "name", defaultValue: "") String name,@JsonKey(name: "full_name", defaultValue: "") String fullName,@JsonKey(name: "player_image", defaultValue: "") String playerImage,@JsonKey(name: "role", defaultValue: "") String role,@JsonKey(name: "country_name", defaultValue: "") String countryName,@JsonKey(name: "country_image", defaultValue: "") String countryImage,@JsonKey(name: "performance_id", defaultValue: "") String performanceId,@JsonKey(name: "runs_scored", defaultValue: 0) int runsScored,@JsonKey(name: "balls_faced", defaultValue: 0) int ballsFaced,@JsonKey(name: "fours", defaultValue: 0) int fours,@JsonKey(name: "sixes", defaultValue: 0) int sixes,@JsonKey(name: "runs_conceded", defaultValue: 0) int runsConceded,@JsonKey(name: "balls_bowled", defaultValue: 0) int ballsBowled,@JsonKey(name: "wickets_taken", defaultValue: 0) int wicketsTaken,@JsonKey(name: "catches", defaultValue: 0) int catches,@JsonKey(name: "dismissals", defaultValue: 0) int dismissals,@JsonKey(name: "caught_behinds", defaultValue: 0) int caughtBehinds,@JsonKey(name: "wides_bowled", defaultValue: 0) int widesBowled,@JsonKey(name: "byes_bowled", defaultValue: 0) int byesBowled,@JsonKey(name: "run_outs", defaultValue: 0) int runOuts,@JsonKey(name: "no_balls_bowled", defaultValue: 0) int noBallsBowled,@JsonKey(name: "catches_dropped", defaultValue: 0) int catchesDropped,@JsonKey(name: "inserted_at") DateTime? insertedAt,@JsonKey(name: "home_team_id", defaultValue: "") String homeTeamId,@JsonKey(name: "home_team_name", defaultValue: "") String homeTeamName,@JsonKey(name: "home_team_image", defaultValue: "") String homeTeamImage,@JsonKey(name: "away_team_id", defaultValue: "") String awayTeamId,@JsonKey(name: "away_team_name", defaultValue: "") String awayTeamName,@JsonKey(name: "away_team_image", defaultValue: "") String awayTeamImage,@JsonKey(name: "fantasy_points", defaultValue: 0) int fantasyPoints
});
...
as String,playerImage: null == playerImage ? _self.playerImage : playerImage // ignore: cast_nullable_to_non_nullable
...
@override@JsonKey(name: "player_image", defaultValue: "") final  String playerImage;
@override@JsonKey(name: "role", defaultValue: "") final  String role;
@override@JsonKey(name: "country_name", defaultValue: "") final  String countryName;
@override@JsonKey(name: "country_image", defaultValue: "") final  String countryImage;
