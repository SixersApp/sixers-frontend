...
mixin _$League {
 ...
 String get id; String get name;@JsonKey(name: "tournament_id") String get tournamentId;@JsonKey(name: "creator_id") String get creatorId;@LeagueStatusConverter()@JsonKey(name: "status") LeagueStatus get status;@JsonKey(name: "max_teams") int get maxTeams;@JsonKey(name: "join_code") String get joinCode;@JsonKey(name: "season_id") String get seasonId;@JsonKey(name: "created_at") DateTime get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,tournamentId,creatorId,status,maxTeams,joinCode,seasonId,createdAt);

@override
String toString() {
  return 'League(id: $id, name: $name, tournamentId: $tournamentId, creatorId: $creatorId, status: $status, maxTeams: $maxTeams, joinCode: $joinCode, seasonId: $seasonId, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String name,@JsonKey(name: "tournament_id") String tournamentId,@JsonKey(name: "creator_id") String creatorId,@LeagueStatusConverter()@JsonKey(name: "status") LeagueStatus status,@JsonKey(name: "max_teams") int maxTeams,@JsonKey(name: "join_code") String joinCode,@JsonKey(name: "season_id") String seasonId,@JsonKey(name: "created_at") DateTime createdAt
});
...
/// Create a copy of League
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? tournamentId = null,Object? creatorId = null,Object? status = null,Object? maxTeams = null,Object? joinCode = null,Object? seasonId = null,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name, @JsonKey(name: "tournament_id")  String tournamentId, @JsonKey(name: "creator_id")  String creatorId, @LeagueStatusConverter()@JsonKey(name: "status")  LeagueStatus status, @JsonKey(name: "max_teams")  int maxTeams, @JsonKey(name: "join_code")  String joinCode, @JsonKey(name: "season_id")  String seasonId, @JsonKey(name: "created_at")  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _League() when $default != null:
return $default(_that.id,_that.name,_that.tournamentId,_that.creatorId,_that.status,_that.maxTeams,_that.joinCode,_that.seasonId,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name, @JsonKey(name: "tournament_id")  String tournamentId, @JsonKey(name: "creator_id")  String creatorId, @LeagueStatusConverter()@JsonKey(name: "status")  LeagueStatus status, @JsonKey(name: "max_teams")  int maxTeams, @JsonKey(name: "join_code")  String joinCode, @JsonKey(name: "season_id")  String seasonId, @JsonKey(name: "created_at")  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _League():
return $default(_that.id,_that.name,_that.tournamentId,_that.creatorId,_that.status,_that.maxTeams,_that.joinCode,_that.seasonId,_that.createdAt);}
}
...
class _League implements League {
  const _League({required this.id, required this.name, @JsonKey(name: "tournament_id") required this.tournamentId, @JsonKey(name: "creator_id") required this.creatorId, @LeagueStatusConverter()@JsonKey(name: "status") required this.status, @JsonKey(name: "max_teams") required this.maxTeams, @JsonKey(name: "join_code") required this.joinCode, @JsonKey(name: "season_id") required this.seasonId, @JsonKey(name: "created_at") required this.createdAt});
...
/// Create a copy of League
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? tournamentId = null,Object? creatorId = null,Object? status = null,Object? maxTeams = null,Object? joinCode = null,Object? seasonId = null,Object? createdAt = null,}) {
