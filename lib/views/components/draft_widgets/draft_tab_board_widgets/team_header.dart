...
class TeamHeader extends StatelessWidget {
  const TeamHeader({super.key, required this.size, required this.name, required this.scheme});
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(name.toUpperCase(), maxLines: 1, overflow: TextOverflow.ellipsis, style: Theme.of(context).textTheme.bodySmall),
            ...
            Expanded(
              child: Center(
                ...
                child: FractionallySizedBox(
                  widthFactor: 0.72, // tweak 0.6–0.9 to taste, or remove for full width
                  child: AspectRatio(
                    aspectRatio: 1,
                    child: Container(
