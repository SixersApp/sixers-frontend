                      ...
                      Builder(
                        builder: (context) {
                          ...
                          if (pick == null && r == rounds) {
                            return const SizedBox.square(dimension: _tileSize);
                          }
...
String toInitials(String input) {
  ...
  final words = noNumbers.trim().split(RegExp(r'\s+'));
