...
class TeamTile extends StatelessWidget {
  const TeamTile({super.key, required this.team, required this.index, this.accentColor, this.logoImage});
  ...
  Color _colorForIndex(int i) {
    const palette = [Color(0xFFF8BD00), Color(0xFF66A3FF), Color(0xFFFF8B66), Color(0xFFFF66D4), Color(0xFF66D18F)];
    ...
    return Container(
      ...
      child: ClipRRect(
        ...
        child: Stack(
          children: [
            Positioned.fill(
              child: DecoratedBox(decoration: BoxDecoration(color: AppColors.black300)),
            ),
                      ...
                      children: [
                        ...
                        ClipRRect(
                          ...
                          child: Container(
                            ...
                            child: logoImage == null ? const Icon(Icons.sports_cricket, color: Colors.white) : null,
                          ),
                        ),
                      ],
                    ),
                      ...
                      text: TextSpan(
                        children: [
                          ...
                          TextSpan(
                            ...
                            style: Theme.of(
                              context,
                            ).textTheme.labelSmall?.copyWith(color: Colors.white70, fontWeight: FontWeight.w500),
                          ),
                        ],
                      ),
                    ),
