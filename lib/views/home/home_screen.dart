  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return authAsync.when(
      ...
      data: (session) {
        ...
        // Fetch matchups using ONLY matchNum
        final matchupsAsync = userId.isEmpty
            ? const AsyncValue.data([])
            : ref.watch(userMatchupsProvider(matchNum: 1)); // Default match_num = 1
              ...
              child: RefreshIndicator(
                onRefresh: () async {
                  ...
                  if (userId.isNotEmpty) {
                    ref.refresh(userMatchupsProvider(matchNum: 1));
                  }
                },
                child: ListView(
                    ...
                    Container(
                      ...
                      child: SizedBox(
                        ...
                        child: userId.isEmpty
                            ? const Center(
                                child: Text('Sign in to view your matchups'),
                              )
                            : () {
                                ...
                                return ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    final team1Name =
                                        m.team1?.fantasyTeam?.teamName ??
                                            'Team 1';
                                    final team2Name =
                                        m.team2?.fantasyTeam?.teamName ??
                                            'Team 2';
                                            ...
                                            .firstWhere(
                                              ...
                                              orElse: () => League(
                                                ...
                                                status:
                                                    LeagueStatus.active,
                                                maxTeams: 0,
                                                joinCode: '', seasonId: '', createdAt: DateTime.now(),
                                              ),
                                            )
                                            .name,
